...
import { getMaterials } from '@/app/actions';
        ...
        <div className={styles.container}>
            ...
            <aside className={styles.sidebar}>
                <header className={styles.sidebarHeader}>
                    <h1>Materialien</h1>
                    <p>Vorlesungsfolien und Zusatzmaterial</p>
                </header>

                <div className={styles.materialList}>
                    {isLoading && <p className={styles.loadingText}>Lade Materialien...</p>}
                    {!isLoading && materials.length === 0 && <p className={styles.loadingText}>Keine Materialien vorhanden.</p>}
            ...
            <main className={styles.viewerPanel}>
                {selectedMaterial ? (
                    ...
                    <div className={styles.emptyState}>
                        ...
                        <p>Klicke auf ein Dokument in der linken Liste, um die Vorschau anzuzeigen.</p>
                    </div>
                )}
            </main>
        </div>
