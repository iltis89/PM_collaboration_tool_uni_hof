...
Im Rahmen der Nutzung der Plattform können folgende Daten verarbeitet werden:
- **Bestandsdaten:** Namen (z.B. User-Logins "Student", "Admin")
- **Inhaltsdaten:** Texteingaben im Chat/Forum, hochgeladene Dateien (sofern implementiert).
- **Nutzungsdaten:** Besuchte Seiten, Zugriffszeiten, Klickpfade (technische Logs).

## 5. Zweck der Verarbeitung
- Bereitstellung der Lernplattform und ihrer Funktionen (Dashboard, Materialien, Collaboration).
- Kommunikation zwischen Studierenden im Rahmen der Vorlesung.
